...
public interface ProductService {
    ...
    Product updateProduct(String id, String email, String name, String description, Integer qty, String productId, java.math.BigDecimal buyingCost, MultipartFile image, boolean isOwner) throws Exception;
    Product getProductByProductId(String productId, String email);
    void deleteProduct(String id);
    void deleteProduct(String id, String email);
    void deleteProduct(String id, String email, boolean isOwner);
    ...
    Product changeQty(String id, String email, int delta, boolean isOwner) throws Exception;
    Product updateProductQuantity(String productId, String email, int newQuantity) throws Exception;
    Product updateProductQuantity(String productId, String email, int newQuantity, boolean isOwner) throws Exception;
